...
export function Card2({ Card2img }) {
    return (
      <div className="w-3xl justify-self-end rounded-R-xl">
        <img
          src='/Card2.jpeg'
...

{
  ...
  const handleGetStarted_Analysis = () => {
    ...
    <div className="mb-10">
      ...
      <p className="mt-4  max-w-3xl text-[20px]  leading-[30px] tracking-[0.12px] text-[#667085] font-[Aeonik TRIAL]"><TranslatorText>Empower yourself with financial knowledge that goes beyond theory.
    ...
    <div className="flex gap-4 mb-10">
      <button className="  hover:bg-gray-400 flex h-[56px] px-[24px] py-[12px]  font-[Aeonik TRIAL]justify-center items-center gap-[8px] rounded-full bg-[#0C0D0E] text-white"   onClick={handleGetStarted}>
       <TranslatorText>Get Started Now</TranslatorText> 
      </button>
      <button className="flex h-[56px] px-[24px] py-[12px] justify-center items-center gap-[8px] 
 font-[Aeonik TRIAL] rounded-full border border-[#E8E8E8] bg-[#F4F4F4] text-[#0C0D0E] text-[16px]  leading-[24px] hover:bg-gray-400 " onClick={handleGetStarted_Analysis}>
  ...
  const FinancialCard = () => {
    ...
    return (
        <div className="flex h-[500px] items-center">  <div className="p-25"></div><div className="bg-white shadow-lg rounded-2xl  p-6 w-[400px] h-[400px] font-[Aeonik TRIAL]">
    ...
    return (
      <div className="w-150 rounded-2xl bg-white flex-wrap">
       ...
       <TranslatorText>Your Personalized Path to Financial Freedom</TranslatorText>   
        ...
        <br />
        <button className="flex h-[56px] px-[24px] py-[12px] justify-center items-center gap-[8px] 
               rounded-full border border-[#E8E8E8] bg-[#F4F4F4] text-[#0C0D0E] 
               font-[Aeonik TRIAL] text-[16px] not-italic font-normal leading-[24px] hover:bg-gray-400"  onClick={handleGetStarted}>
...
const handleGetStarted_Analysis = () => {
    ...
    return (
     ...
     <TranslatorText> Casbank provides reliable financial services for various business needs powered by the latest AI. We are pioneers in this service field, and the best among others.</TranslatorText>  
        ...
        <button className="flex h-[56px] px-[24px] py-[12px] justify-center items-center gap-[8px] 
               rounded-full border border-[#E8E8E8] bg-[#F4F4F4] text-[#0C0D0E] 
               font-[Aeonik TRIAL] text-[16px] not-italic font-normal leading-[24px] hover:bg-gray-400" onClick={handleGetStarted_Analysis} >
<TranslatorText>Analyse Portfolio  </TranslatorText>      </button>
      </div>
    );
  };
